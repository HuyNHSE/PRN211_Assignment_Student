...
public partial class Prn231Su23StudentGroupDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Student__3214EC0700FB665C");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__StudentG__3214EC07AB710997");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__UserRole__3214EC07E3FE72CA");

            entity.ToTable("UserRole");

            entity.HasIndex(e => e.Username, "UQ__UserRole__536C85E41BC45CDC").IsUnique();
